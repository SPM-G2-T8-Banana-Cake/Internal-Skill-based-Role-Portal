...
function Footer(props) {
    return (
        <Navbar className={props.type + ' justify-content-center py-4 text-light footerText'}>
            <Row className="mx-5 px-5">
                ...
                <Col sm={12} md={6} lg={3}>
                    ...
                    <span>
                        <a className="text-light text-decoration-none" href="https://projectsuccess.com.sg/" target='_blank' rel="noreferrer">Project Success Website</a>
                    </span>
                    <br /><br />
                    <span>
                ...
                <Col sm={12} md={6} lg={3}>
                    <span>© 2023 Project Success, Inc. All rights reserved.</span>
                </Col>
            </Row>
        </Navbar>
    )
